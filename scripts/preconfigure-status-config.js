...
var StatusConfig = require('../src/models/StatusConfig').default;
var DEMO_USER_ID = '68144435f74e9d8077904b14';
var STATUS_CONFIG = [
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, StatusConfig.findOneAndUpdate({ userId: DEMO_USER_ID }, { statuses: STATUS_CONFIG }, { upsert: true, new: true })];
                case 2:
                    _a.sent();
